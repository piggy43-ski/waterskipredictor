...
export const UserAnalyticsDrilldown = ({ userId, username, onBack }: UserAnalyticsDrilldownProps) => {
  ...
  const getTransactionBadge = (type: string) => {
    const typeColors: Record<string, string> = {
      ...
      'entry_placed': 'bg-orange-500/10 text-orange-500 border-orange-500/20',
      'prediction_won': 'bg-green-500/10 text-green-500 border-green-500/20',
      'prediction_lost': 'bg-red-500/10 text-red-500 border-red-500/20',
      'prediction_void': 'bg-muted text-muted-foreground',
