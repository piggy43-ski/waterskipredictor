...
import { calculateParlayMultiplier, getMultiplierSuggestions, isDuplicateLeg } from '@/utils/parlayMultipliers';
...
export function ParlayBuilder({
  ...
  const multiplier = calculateParlayMultiplier(legs.filter(l => l.isComplete));
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-primary/10 rounded-lg p-4">
          <div className="text-2xl font-bold text-center">{multiplier}x Multiplier</div>
