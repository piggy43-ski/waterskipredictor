...
export const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    content: 'You start with 0 tokens. Buy tokens to enter prediction contests and earn reward tokens for gear and experiences. Tokens have no cash value.',
    placement: 'bottom',
    route: '/',
  },
  {
    ...
    title: 'Get Tokens',
    content: 'Tap here to buy tokens. Daily limit: $250 (25,000 tokens). Use tokens to enter contests.',
    placement: 'left',
    route: '/',
  },
  {
